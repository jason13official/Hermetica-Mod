...
public class ModBlocks {
  ...
  public static void register(BiConsumer<Block, ResourceLocation> consumer) {
    ...
    TOWER_HEART = construct("tower_heart", Block::new, Properties.of(), consumer);
    VESTIGIAL_TOWER_HEART = construct("vestigial_tower_heart", Block::new, Properties.of(), consumer);
  }
